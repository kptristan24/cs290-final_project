...
<html lang="en">
  <head>
    ...
    <title>Hearthstone Card Collector</title>
...
================================================== -->
  <body>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Welcome to the Hearthstone Card Collector!</h1>
              <p>If you're on this page, you're in the right place! You can use the navigation bar at the top to begin using the APP! or, if you're new here, click on the create profile button and begin!</p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>You can view all the cards you've collected by clicking "view" button on the drop down above</p>
            </div>
          </div>
        </div>
        <div class="item">
    ...
    <script src="../../../libraries/bootstrap-3.3.4-dist/js/vendor/holder.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="../../../libraries/bootstrap-3.3.4-dist/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
